...
export default function InvitationMessageButton({ inviteCode }: { inviteCode: string }) {
  ...
  return (
    <button
      onClick={handleCopy}
      className="flex items-center gap-1.5 text-xs font-semibold px-3 py-1.5 rounded-lg bg-[#18182a] border border-[#2a2a45] text-[#64748b] hover:text-[#f1f5f9] hover:border-[#3b3b60] transition-colors"
    >
      {copied ? (
